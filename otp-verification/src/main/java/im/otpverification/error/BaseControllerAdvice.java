package im.otpverification.error;

import im.otpverification.dto.ErrorResponse;
import im.otpverification.error.exception.BadRequestException;
import im.otpverification.error.exception.DataNotFoundException;
import im.otpverification.error.exception.DuplicateException;
